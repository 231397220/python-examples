...
class ZhiHuSpider(object):
    ...
    def get_xsrf(self):
        ...
        response = self.session.get(
            'https://www.zhihu.com', headers=self.headers)
        html = response.text
        get_xsrf_pattern = re.compile(
            r'<input type="hidden" name="_xsrf" value="(.*?)"')
        ...
        while record_num < total:
            ...
            if datas is not None:
                ...
                for data in datas:
                    ...
                    answer = data['author']['name'] + ' ' + \
                        str(data['voteup_count']) + ' 人点赞' + '\n'
